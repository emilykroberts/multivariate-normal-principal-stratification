...
s1 = rinvgamma(1, shape = a + n/8, scale = (sum(tmp1[trt==0]^2)/2 + b))
s2 = rinvgamma(1, shape = a + n/8, scale = (sum(tmp2[trt==1]^2)/2 + b))
s3 = rinvgamma(1, shape = a + n/8, scale = (sum(tmp3[trt==0]^2)/2 + b))
s4 = rinvgamma(1, shape = a + n/8, scale = (sum(tmp4[trt==1]^2)/2 + b))
